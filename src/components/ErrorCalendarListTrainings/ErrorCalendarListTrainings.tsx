...
import { BlureModalCalendar, Text, TextTitle, WrapBtn, WrapperButton, WrapperContent, WrapperModal, WrapperText } from './ErrorCalendarListTrainings.styles';
...
{errorTrainingsList &&
  ...
  <BlureModalCalendar />
    <WrapperModal>
    <WrapperContent>
      <div><CloseCircleOutlined style={{fontSize: '24px', color: 'rgba(47, 84, 235, 1)'}} /></div>
      <WrapperText>
